...
const RELEASES_URL = 'https://github.com/NGXSMK/ngxsmk-gamenet-optimizer/releases';
      ...
      <header className="header">
        <div className="container header-inner">
          ...
          <nav className={`nav ${menuOpen ? 'open' : ''}`}>
            ...
            <a href={RELEASES_URL} target="_blank" rel="noopener noreferrer" className="nav-download">Download</a>
          </nav>
          ...
          <div className="container">
            <div className="hero-content">
              ...
              <div className="hero-actions">
                <a href={RELEASES_URL} target="_blank" rel="noopener noreferrer" className="btn btn-primary btn-large">
        ...
        <div className="container">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <a href="#features" onClick={(e) => { e.preventDefault(); scrollTo('features'); }}>Features</a>
              <a href="#showcase" onClick={(e) => { e.preventDefault(); scrollTo('showcase'); }}>Screenshots</a>
              <a href={RELEASES_URL} target="_blank" rel="noopener noreferrer">Download</a>
              <a href={GITHUB_REPO} target="_blank" rel="noopener noreferrer">Source Code</a>
            </div>
            <div className="footer-col">
              <h4>Support</h4>
